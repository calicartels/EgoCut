...
VJEPA2_T_TOKENS = FRAMES_PER_CLIP // VJEPA2_TUBELET_SIZE   # 8
VJEPA2_H_TOKENS = VJEPA2_IMG_SIZE // VJEPA2_PATCH_SIZE      # 24
VJEPA2_W_TOKENS = VJEPA2_H_TOKENS                           # 24
VJEPA2_N_PATCHES = VJEPA2_T_TOKENS * VJEPA2_H_TOKENS * VJEPA2_W_TOKENS  # 4608

# ── Factories ────────────────────────────────────────────────────────
# factory006 and factory010 dropped
TASKS = {
    "factory001": {
    ...
    "factory008": {
        ...
        "description": (
            ...
            "wires, places completed unit back on belt."
        ),
        "avg_cycle_s": 3.0,
